...
function delete2(dd){
	...
	var state = $('label[for=' + 'd' + dd + ']').attr("class");
	...
	if ("chkbox focus" == state) {
		...
		$.ajax({
			...
			success : function(data) {
				setTimeout(function() {
           		 window.location.href='doctorlistneedjudge.jsp';
				}, 1000);
...
<body>
		...
		<div class="row" style="width: 100%; height: 100%">
			<div class="col-md-12" style="width: 100%; height: 100%">
				...
				<div class="card" style="width: 100%; height: 100%"">
					<div class="card-action">更改权限</div>
					<div class="card-content" style="width: 100%; height: 100%">
						<div class="table-responsive" style="width: 100%; height: 100%">
							<table class="table table-striped table-bordered table-hover"
								...
								<tbody>
									<c:forEach items="${sessionScope.docotorlist2}" var="thing">

										<tr class="odd gradeX">

											<td>${thing.uregisteId}</td>
											<td>${thing.uid}</td>
											<td>${thing.uname}</td>
											<td>${thing.uage}</td>
											
											<td>${thing.uaddress}</td>
											<td>${thing.uemail}</td>
											<td><input type="checkbox" id="d${thing.uregisteId}"
													name="chk" onclick="delete2('${thing.uregisteId}');"/></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
	...
	<!-- DATA TABLE SCRIPTS -->
	<script src="assets/js/dataTables/jquery.dataTables4.js"></script>
