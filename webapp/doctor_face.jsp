...
<body>
		...
		<div class="top_main">
			...
			<div class="dh_bg">
				<ul>
					...
					<li class="cur"><a href="about.html"> <i
	...
	<div id="content">
		...
		<div class="left_menu">
			<div id="ss" style="height: 50px; width: 100%"></div>
			<ul id="nav_dot">
				...
				<li>
					...
					<div class="list-item none">
						<a id="uploadImage">上传头像</a> <a id="showinfoselef">修改个人信息</a> <a
							id="updatepassword">修改密码</a> <a id="changeGrand">更改他人权限</a>
					</div>
				</li>
				...
				<li>
					...
					<div class="list-item none">
						<a id="showInfoAppoint">预约信息</a> <a id="inputCheckResoult">录入病人检查结果</a>
						<a id="showallpationgivemoney">查看病人单项检查结果</a> <a
							id="showallhomposital">办理出入院</a> <a id="serarchandemail">指定搜索相关人员</a>

						<a id="inputBlood">登记献血记录</a> <a id="useBlood">登记用血记录</a> <a
							id="showbloodhistory">血液使用记录情况</a> <a id="showMedicineandinput">完善药品信息(录入信息)</a>
					</div>
				</li>
		...
		<div id="ss1" style="height: 50px; width: 100%"></div>

		<div class="m-right" style="height: 100%;">

			<div class="main" style="height: 100%;">
				<iframe name="iframe_content" id="iframe_content" width="100%"
					height="100%" src="search.html"  scrolling="no" frameborder="0"></iframe>
			</div>
		</div>
	</div>
